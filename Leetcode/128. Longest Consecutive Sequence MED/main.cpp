...
void solve() {
    // Your solution here
    //given an unsorted array of integers aand we have to
    //we have to return a length of the longest consecutive elements seq
    ...
    //fuckign at 0 1 1 2
    // res 2 max = 2
    // this mean do we have to remove duplicates?
    //ig yeahhhhhhhh
}
