...
void solve() {
    // Your solution here
    //observation the values are resonating in 2 values we have to take the max of it
    //but when to stop is still the concern
    ...
    // algo works perfect for the odd l; what the fuck go`t for evens
