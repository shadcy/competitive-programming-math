...
void solve() {
    ...
    auto cook = [&](ll k, ll a, ll b, ll x, ll y) -> ll {
        ll count = 0;
        if (k >= a) {
            ll cnt1 = (k - a) / x + 1;
            count += cnt1;
    ...
    // Try both orders and take the max
    ll ans1 = cook(k, a, b, x, y); // Type 1 then Type 2
    ll ans2 = cook(k, b, a, y, x); // Type 2 then Type 1
