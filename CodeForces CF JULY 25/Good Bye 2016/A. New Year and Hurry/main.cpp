...
void solve() {
    // Your solution here
    // we exactly have 4 hours to solve the problem which can be converted to mins = 4 * 60 = 240 min
    // and for every problem we at least/need the 5*i hours
    // we know we gonna need k hrs in first to go back
