...
void solve() {
    // Your solution here
    //each team has 
    //1. home and 2. away kit for sootball
    //kit for home games of ith team is xi
    //jit for away teams has color yi (xi != yi)4

    //n * (n-1) games
    //each team plays exaclty 1 home game and 1 away game
