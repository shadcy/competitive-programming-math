...
void solve() {
    ...
    cin>>a1>>a2>>b1>>b2;
    int ans = 0;
        // Case 1: (a1 vs b1, a2 vs b2)
    {
        int s = 0, t = 0;
        if (a1 > b1) s++; else if (a1 < b1) t++;
        if (a2 > b2) s++; else if (a2 < b2) t++;
        if (s > t) ans++;
    }
    // Case 2: (a1 vs b2, a2 vs b1)
    {
        int s = 0, t = 0;
        if (a1 > b2) s++; else if (a1 < b2) t++;
        if (a2 > b1) s++; else if (a2 < b1) t++;
        if (s > t) ans++;
    }
    // Case 3: (a2 vs b1, a1 vs b2)
    {
        int s = 0, t = 0;
        if (a2 > b1) s++; else if (a2 < b1) t++;
        if (a1 > b2) s++; else if (a1 < b2) t++;
